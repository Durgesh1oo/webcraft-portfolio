  ...
  return (
    <section id="home" className="relative pt-16 min-h-screen flex items-center overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full" ref={heroRef}>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start min-h-[calc(100vh-64px)] py-12">
          {/* Left: Text */}
          ...
          {/* Right: Stats */}
         <div className="lg:col-span-4 flex flex-col items-end text-right self-start pt-8 lg:pt-12">
